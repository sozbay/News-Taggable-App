...
@section('content')
         <form class="source-item pt-4 px-0 px-sm-4 " action="{{route('videoUpdate')}}" method="post"
            ...
            <div class="row">
                ...
                @endif
                @csrf
                <h3 class="card-header">Video Detay</h3>
                <hr>
                @if ($errors->any())
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control" type="text" value="{{$video->title}}" name="title"
                                           id="html5-text-input">
                                </div>
                            </div>
                            <label for="html5-text-input" class="col-md-4 col-form-label">Video</label>
                            <div class="mb-3">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="select2-primary">
                                    <select id="select2Primary" class="select2 form-select" name="tags[]" multiple
                                        ...
                                        @foreach($tags as $tag)
                                            <option
                                                @if(in_array($tag->id,$video->taggable->pluck('tag_name_id')->toArray(),false)) selected
