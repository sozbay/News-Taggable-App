...
@section('content')
         <form class="source-item pt-4 px-0 px-sm-4 " action="{{route('videoStore')}}" method="post"
            ...
            <div class="row">
                ...
                @endif
                <h3 class="card-header">Video Ekle</h3>
                <hr>
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="mb-3 row">
                                <label for="html5-text-input" class="col-md-4 col-form-label">Video Adı</label>
                                <div class="col-md-12">
